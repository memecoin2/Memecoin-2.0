// Website  :https://www.memecoin2.org
...
contract MemeCoin2 is Context, IERC20, Ownable {
    ...
    string private _name     = "Memecoin 2.0";
    ...
    {        
        ...
        marketingWallet = 0x5c42bB9579cac3be7EaA2D83e64E37D197279dd6;
    ...
    function setBuyFeePercentages(uint256 _taxFeeonBuy, uint256 _buybackBurnFeeOnBuy, uint256 _marketingFeeonBuy) external onlyOwner {
        ...
        require(totalBuyFees <= 2, "Buy fees cannot be greater than 2%");
    ...
    function setSellFeePercentages(uint256 _taxFeeonSell, uint256 _buybackBurnFeeOnSell, uint256 _marketingFeeonSell) external onlyOwner {
        ...
        require(totalSellFees <= 6, "Sell fees cannot be greater than 6%");
